        ...
        <form style={formStyle} onSubmit={handleSubmit} >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ margin: '0 0 10px 0' }}>
                    <TextField id="outlined-basic" label="Username" autoComplete='off' required value={name} onChange={(e) => setName(e.target.value)} />
                </div>
                <div style={{ margin: '0 0 10px 0' }}>
                    <TextField id="outlined-basic" label="E-mail" autoComplete='off' required value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
                <div style={{ margin: '0 0 10px 0' }}>
                ...
                <div style={{ margin: '10px 0 10px 0' }}>
                    <Button variant="contained" color="warning" size="medium" type="submit" >Submit</Button>
                </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'row' }}>
                <label style={lableStyle}> Already Have An Account? </label>
                <Button variant="text" color="success" size="medium" type="submit" onClick={() => navigate('/')}>Login</Button>
            </div>
        </form>
    );
};
